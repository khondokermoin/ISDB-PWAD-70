...
function handle_checkin(): void {
  ...
  // Device token (optional enforcement if admin configured allowed_device_tokens)
  // NOTE: This token is generated by the browser (localStorage). It is not a hardware identifier.
  $body = get_json_body();
  ...
  // Per-user device token restriction (if set, must match)
