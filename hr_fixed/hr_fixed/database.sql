...
CREATE TABLE IF NOT EXISTS users (
  ...
  -- Optional per-user attendance device restriction.
  -- NOTE: A web browser cannot reliably read the true hardware MAC address.
  -- This field is supported for environments where the client/app can provide a device MAC.
  -- If set, employee can check-in/out only when the provided device MAC matches.
  allowed_mac VARCHAR(255) NULL,
